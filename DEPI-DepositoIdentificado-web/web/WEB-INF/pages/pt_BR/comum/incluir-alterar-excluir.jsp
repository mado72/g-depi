		...
		<tr>
			<td align="center">
				<div id="tabela_botoes"><c:url var="btnIncluirUrl" value="${namespaceEditar}/incluir.do"/>
					...
					<a class="abtn" id="BtnAlterar"><img src="<c:url value="${www3}padroes_web/intranet/imagens/bt_alterar.gif"/>"></a>
					<a class="abtn" id="BtnExcluir"><img src="<c:url value="${www3}padroes_web/intranet/imagens/bt_excluir.gif"/>"></a>
				</div>
			</td>
		</tr>
	</table>
