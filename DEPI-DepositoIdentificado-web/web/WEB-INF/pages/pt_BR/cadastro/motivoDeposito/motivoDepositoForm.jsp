...
<s:form action="salvar">
	...
	<tbody>
		<tr>
			...
			<td colspan="3" >
				<s:textfield tabindex="1" property="descricaoBasica" styleClass="input" style="text-transform: uppercase;"  maxlength="20" size="26" disabled="detalhar"/>
			</td>
		</tr>
		<tr>
			<td class="td_label"><s:text name="label.cadastro.motivodeposito.descricaoDetalhada" /><span class="obrigatorio">*</span></td>
			<td colspan="3">
				<s:textarea property="descricaoDetalhada" rows="5" tabindex="2" cols="70" style="text-transform: uppercase;" readonly="detalhar"/>
			</td>
		</tr>
	</tbody>
	</table>
				...
				<td align="center" valign="middle" colspan="3">
					<c:choose>
						<c:when test="${detalhar}">
							<button class="submit" id="BtnVoltar">
						...
						<c:otherwise>
							...
							<button class="btn-img" id="BtnCancelar">
