...
public class ParcelaCobrancaVO implements Serializable {
	...
	/**
	 * Método que retorna o objeto com os dados de dep�sito.
	...
	/**
	 * Método que define o objeto com os dados de dep�sito.
	...
	/**
	 * Método que retorna a data/hora da inclus�o.
	...
	/**
	 * Método que define a data/hora da inclus�o.
	...
	/**
	 * Método que retorna a data/hora da �ltima atualiza��o.
	...
	/**
	 * Método que define a data/hora da �ltima atualiza��o.
