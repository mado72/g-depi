...
public final class BaseUtil {
	 ...
	 *             - SQLException.
	 */
	public static Object setNullQuandoOpcional(Object x, String indicativo)
			throws SQLException {
	 ...
	 *             - SQLException.
	 */
	public static Object setNullQuandoOpcional(Object x, boolean indicativo)
			throws SQLException {
		if (indicativo) {
			return null;
		}
	 ...
	 */
	public static void assertTrueThrowException(boolean b, String chave,
			List<Message> msg) throws IntegrationException {
		if (b) {
	 ...
	 */
	public static void assertTrueThrowException(boolean b, String chave,
			String msg) throws IntegrationException {
		if (b) {
			throw new BusinessException(msg);
		}
	}
	 ...
	 *             - IntegrationException.
	 */
	public static void validarParametro(String param, Object valor,
			String nomeParametro) throws IntegrationException {
		assertTrueThrowException(ConstantesDEPI.CODIGO_SIM.equals(param)
				&& isNZB(valor), ConstantesDEPI.ERRO_CAMPO_OBRIGATORIO,
				nomeParametro);
	}
	 ...
	 *             - IntegrationException.
	 */
	public static void validarParametro(Object valor, String nomeParametro)
			throws IntegrationException {
	...
	/**
	 * Permite a abstração das verificações de preechimento de propriedades e
	 * estado válido para acesso à objetos. Quando uma propriedade for
	 * refatorada não haverá necessidade de alterar em várias partes as
	 * verificações incluidas neste método.
	 * 
	 * @author Fábio Henrique fabio.almeida@cpmbraxis.com NZB - Null; Zero;
	 *         String Zero Sequencies; Blank; Método utilitário para
	 * @param valor
	 *            - objeto a ser verificado.
	 * @return um boolean com true (se o objeto é nulo ou vazio) ou false (se o
	 *         objeto é diferente de nulo ou vazio)
	 */
	...
	public static boolean isNZB(Object valor) {
		...
		if (valor instanceof String) {
			...
			if (((String) valor).matches("((-|\\+)?[0-9]+(\\.[0-9]+)?)+")) {
				return Double.parseDouble(prepareStringToNumber(valor
						.toString())) <= 0.0;
			}
		}
		...
		if (valor instanceof Double || valor instanceof Integer
				|| valor instanceof Long || valor instanceof Float
	...
	public static boolean isSorN(String valor) {
		if (isNZB(valor)) {
			...
			if (!ConstantesDEPI.CODIGO_NAO.equals(valor)
					&& !ConstantesDEPI.CODIGO_SIM.equals(valor)) {
				return false;
			}
		}
		return true;
	...
	/**
	 * Método utilitário para verificar se um objeto maior que o esperado
	 * Retorna true se forma maior que o parametro
	 * 
	 * @param valor
	 *            - Object
	 * @param size
	...
	/**
	 * NZB - Null; Zero; Blank Método utilitário para verificar se um objeto é
	 * nulo ou vazio.
	 * 
	 * @param valor
	 *            - objeto a ser verificado.
	...
	/**
	 * Metodo utilitário pra converter uma objeto String para um objeto tipo
	 * Date.
	 * 
	 * @param valor
	...
	/**
	 * Metodo utilitário pra converter uma objeto String para um objeto tipo SQL
	 * Date.
	 * 
	 * @param valor
	 *            - Valor a ser convertido.
	...
	public static java.sql.Date parserStringToSQLDate(String valor) {
		return new java.sql.Date(parserStringToDate(valor, "dd/MM/yyyy")
				.getTime());
	}

	/**
	 * Metodo utilitário pra converter um objeto SQL Date em uma String com o
	 * formato informado.
	 * 
	 * @param data
	 *            - Date a ser convertido.
	 * @param pattern
	 *            - O pattern da data.
	 * @return String - A data formatada.
	 */
	public static String parserSQLDateToString(java.sql.Date data,
			String pattern) {
		return new SimpleDateFormat(pattern).format(java.sql.Date.valueOf(data
				.toString()));
	}
	...
	/**
	 * Método responsável por verificar se um objeto é nulo, caso sim retorna
	 * uma strig vazia.
	 * 
	 * @param obj
	 *            - objeto a ser verificado.
	 * @return Object - o proprio objeto se for diferente de nulo ou vazio se
	 *         igual a nulo.
	 */
	...
	/**
	 * Método responsável por verificar se uma string é nula, caso sim retorna
	 * uma strig vazia.
	 * 
	 * @param str
	 *            - string a ser verificado.
	 * @return String - a própria string se for diferente de nulo ou vazio se
	 *         igual a nulo.
	 */
	...
	/**
	 * Método responsável por verificar se um número é nulo, caso sim retorna
	 * uma string vazia.
	 * 
	 * @param num
	 ...
	 * 
	 * @param str
	 *            Cnpj com máscara que será desformatado
	 * @return String
	 */
	...
	/**
	 * Substitui TODAS as occorencias de uma String alvo por uma String de
	 * substituicao dentro da string principal eg: StringBuffer sb = new
	 * StringBuffer("10 20 30 10 50 60 10"); String alvo = "10"; String
	 * substituicao = "07"; StringUtils.replace(sb,alvo,substituicao); // sb =
	 * "07 20 30 07 50 60 07"
	 * 
	 * @param buffer
	 ...
	 *            java.lang.String
	 */
	public static void replaceString(final StringBuffer buffer,
	...
	/**
	 * Substitui TODAS as ocorrências de uma String alvo por uma String de
	 * substituição dentro da string principal eg: StringBuffer sb = new
	 * StringBuffer("10 20 30 10 50 60 10"); String alvo = "10"; String
	 * substituição = "07"; StringUtils.replace(sb,alvo,substituição); // sb =
	 * "07 20 30 07 50 60 07"
	 * 
	 * @param buffer
	 *            java.lang.StringBuffer
	 ...
	 *            java.lang.String
	 */
	public static void sliceString(final StringBuffer buffer,
			final String find, final String replace) {
		String strBuff = buffer.toString();
		int i = strBuff.indexOf(find);
		while (i != -1) {
	...
	/**
	 * Verifica se o valor de um objeto corresponde a um campo vazio de uma
	 * tabela
	 * 
	...
	/**
	 * Método que compara as datas verificando se a Data Inicial é maior do que
	 * a Data Final.
	 * 
	 * @param dIni
	 *            - parâmetro da data inicial.
	 * @param dFim
	 *            - parâmetro da data final.
	 * @return boolean - retorna um booleano.
	 * @throws IntegrationException
	 *             IntegrationException.
	 */
	public static boolean compararSeDataInicialEMaiorQueFinal(Date dIni,
			Date dFim) throws IntegrationException {
	 ...
	 *             IntegrationException.
	 */
	public static boolean verificarSeDataEMaiorQueDataCorrente(Date data)
			throws IntegrationException {
	 ...
	 * @return boolean - retorna um booleano.
	 */
	public static boolean compararSeDataInicialEMaiorQueFinal(String dIni,
			String dFim) {
	...
	/**
	 * Método responsável por converter um data do Tipo Date para
	 * XMLGregorianCalendar.
	 * 
	 * @param date
	 *            Data do java a ser passada para o método.
	 * @return xmlDate Data já convertida que será enviada para o WebService.
	 * @throws IntegrationException
	 *             Qualquer erro de integração.
	 */
	public static XMLGregorianCalendar dateToXMLDate(Date date)
		...
		try {
			...
			xmlDate = df
					.newXMLGregorianCalendarDate(year, month, day, c
	 ...
	 * 
	 * @param date
	 *            Data a ser passada para o método.
	...
	public static String concatenar(String separador, String arg0,
			String... args) {
	...
	public PropertyResourceBundle getResources() {
		return (PropertyResourceBundle) ResourceBundle
				.getBundle(ConstantesDEPI.PATHCONFIG);
	}
	 ...
	 * 
	 * @param chave
	 *            Chave que contém o padrão da mensagem
	 * @param parametro
	 ...
	 */
	public static String getTextoFormatado(String chave, String parametro,
			String... strings) {
		return getInstance()
				.getTextoFormatadoInterno(chave, parametro, strings);
	}

	private String getTextoFormatadoInterno(String chave,
			String chaveParametro, String... strings) {
	...
	public static <T> List<T> obterItensSemIntersecao(List<T> listaAlteravel,
			Collection<T> itensAComparar, Funcao<T, ?> extrator) {
	...
	public static <T> List<T> obterItensComIntersecao(List<T> listaAlteravel,
			Collection<T> itensAComparar, Funcao<T, ?> extrator) {
		ArrayList<T> copia = new ArrayList<>(listaAlteravel);
	...
	public static String getTexto(Class<? extends IEntidadeCampo> entidade,
			String campo) {
		String simpleName = entidade.getSimpleName();
		StringBuilder sb = new StringBuilder("enum.").append(simpleName)
				.append('.').append(campo);
		return getTexto(sb.toString());
	}

	public final static Object copyProperties(Object newObject, Object oldObject)
	...
	/**
	 * Compara valores de objetos diferentes retornando uma lista do tipo
	 * Field.
	 * 
	 * @param oldObj
	 *            - Object
	 ...
	 */
	public static List<Field> extractModifiedFields(Object oldObj, Object newObj)
			throws IllegalArgumentException, IllegalAccessException {
		if (!newObj.getClass().isAssignableFrom(oldObj.getClass())) {
			throw new IllegalArgumentException(
					"extractModifiedFields: both objects must be compatible type.");
		}
		List<Field> fieldMetadatas = new ArrayList<Field>(1);

		Field[] fields = newObj.getClass().getFields();
		for (Field field : fields) {
			Object valueNew = field.get(newObj);
			Object valueOld = field.get(oldObj);

			if (valueNew == valueOld) {
				continue;
			} else if (valueNew == null || valueOld == null
					|| !valueNew.equals(valueOld)) {
	...
	/**
	 * Encontra diferenças entre dois objetos de mesma classe
	 * @param oldObject Objeto antigo
	 * @param newObject Objeto novo
	 * @param propertyNamesToAvoid Campos para serem ignorados. Se nulo, nenhum campo será ignorado.
	 * @param deep Profundidade da pesquisa
	 * @return Objeto com os dados diferentes.
	 */
	public static Map<String, Object[]> compararObjects(Object oldObject, Object newObject, Set<String> propertyNamesToAvoid, Long deep) {
	    return compararObjects(oldObject, newObject, propertyNamesToAvoid, deep, null);
	}
	...
	private static Map<String, Object[]> compararObjects(Object oldObject, Object newObject, Set<String> propertyNamesToAvoid, Long deep,
	    ...
	    for (Object propNameObject : map.keySet()) {
	        ...
	        if (!propUtils.isWriteable(newObject, propertyName) || !propUtils.isReadable(newObject, propertyName)
	        ...
	        try {
	            if (property1 != null && property2 != null
	                ...
	                for (String prop : propDiff) {
	                	mapProps.put(propertyName + "." + prop, diffProperty.get(prop));
					}
	            } else {
	                if (!Objects.deepEquals(property1, property2)) {
		                mapProps.put(propertyName, new Object[]{property1, property2});
	                }
	            }
	        } catch (Exception e) {
	        }
