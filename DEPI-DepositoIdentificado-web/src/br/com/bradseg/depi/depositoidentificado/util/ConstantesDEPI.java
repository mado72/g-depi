...
public final class ConstantesDEPI {
    ...
    /**
     * Conta Corrente Motivo Dep�sito.
     */
    ...
    public static final String TABELA_CONTA_CORRENTE_AUTORIZADA_CONTA_INTERNA = "CCTA_CORR_AUTRZ"; // CONTA INTERNA
  ...
  // ConstantesDEPI gerais da aplica��o.
