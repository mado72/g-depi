...
@Controller
@Scope("session")
public class ContaCorrenteConsultarAction extends FiltroAction<ParametroDepositoCampo, FiltroConsultarForm<ParametroDepositoCampo>> {
	...
	public ContaCorrenteConsultarAction() {
