...
@Controller
@Scope("session")
public class AssociarMotivoDepositoEditarAction extends EditarFormAction<DepartamentoCompanhiaCampo, DepartamentoCompanhiaVO, DepartamentoCompanhiaEditarFormModel> {
