...
@Controller
@Scope("session")
public class AssociacaoMotivoDepositoConsultarAction extends FiltroAction<ContaCorrenteAutorizadaCampo, FiltroConsultarForm<ContaCorrenteAutorizadaCampo>> {

	protected static final Logger LOGGER = LoggerFactory.getLogger(AssociacaoMotivoDepositoConsultarAction.class);
