...
@Controller
@Scope("session")
public class MotivoDepositoEditarAction extends CrudAction<MotivoDepositoEditarForm, MotivoDepositoVO> {
	...
	@Override
	protected CrudHelper<?, MotivoDepositoVO> getCrudHelper() {
		if (crudHelper == null) {
