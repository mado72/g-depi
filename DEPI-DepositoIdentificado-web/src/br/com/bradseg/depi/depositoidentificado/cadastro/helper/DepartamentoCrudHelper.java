...
public class DepartamentoCrudHelper implements
		CrudHelper<DepartamentoCampo, DepartamentoVO> {
	...
	public void preencherFormularioEdicao(CrudForm model)
		...
		DepartamentoVO instancia = obterPeloCodigo(form.getCodigo());
		form.setDetalhar(false);
		form.setCodigo(String.valueOf(instancia.getCodigoDepartamento()));
		form.setSiglaDepartamento(instancia.getSiglaDepartamento());
		form.setNomeDepartamento(instancia.getNomeDepartamento());
	}
